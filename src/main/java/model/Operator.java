...
public class Operator {
    ...
    //operator_id
    public int getOperator_id() {return operator_id.get();}
    public void setOperator_id(int operator_id) {this.operator_id.set(operator_id);}
    public IntegerProperty operator_idProperty() {return operator_id;}
    ...
    //user_privilege
    public String getUser_privilege() {return user_privilege.get();}
    public void setUser_privilege(String user_privilege) {this.user_privilege.set(user_privilege);}
    public StringProperty user_privilegeProperty() {return user_privilege;}
}
